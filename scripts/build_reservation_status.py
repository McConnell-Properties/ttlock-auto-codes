...
def main():
    ...
    # After normalization, your actual date columns are:
    # dtstart_(check-in)
    # dtend_(check-out)
    ...
    # ---------------------------------
    # Identify platform bookings (need deposit)
    # ---------------------------------
    ...
    # ---------------------------------
    # Parse check-in / check-out dates correctly
    # ---------------------------------
    ...
    print(f"✅ reservation_status.csv written to {OUTPUT} with {len(final)} rows.")
